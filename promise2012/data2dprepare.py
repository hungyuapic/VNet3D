...
def resize_image_itk(itkimage, newSpacing, resamplemethod=sitk.sitkNearestNeighbor):
    ...
    if itkimage.GetSize()[0] != 512:
        newSpacing[0] = itkimage.GetSize()[0] / 512 * originSpcaing[0]
    if itkimage.GetSize()[1] != 512:
        newSpacing[1] = itkimage.GetSize()[1] / 512 * originSpcaing[1]
...
def processOriginaltraindata():
    expandslice = 5
    trainImage = "C:\\Data\\PROMISE2012\\promise2012\\process\\image\\"
    trainMask = "C:\\Data\PROMISE2012\\promise2012\\process\\mask\\"
    """
    ...
    luna_path = "C:\\Data\\PROMISE2012\\promise2012\\train\\src/"
    luna_subset_path = luna_path + "/"
    output_path = "C:\\Data\\PROMISE2012\\promise2012\\train\\mask/"
    ...
    for fcount in range(len(file_list)):
        ...
        sub_img_file = file_list[fcount][len(luna_subset_path)-1:-4]
